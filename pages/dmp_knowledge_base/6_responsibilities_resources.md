...
- Resources e.g. {% tool "openaire" %}: [section on costs of RDM](https://www.openaire.eu/how-to-comply-with-horizon-europe-mandate-for-rdm), {% tool "openaire-rdm-costs-tool" %}
