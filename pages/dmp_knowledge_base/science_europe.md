...
The core part of the knowledge base is based on the {% tool "science-europe-dmp-guidance" %}. Each section is annotated and mapped to relevant persistent identifiers, interested stakeholders, project phase, and the {% tool "rda-dmp-common-standard" %} (version 1.1).
...
Each section is complemented by more extensive explanations and the {% tool "nfr-dmp-guidance" %}, the {% tool "horizon-europe-dmp-template" %}, the {% tool "fair-aware-additional-guidance" %}. Provided information and annotations are specific to jurisdiction, stakeholders, and guidance documents in Norway and reflect the status in 2024. Institutional policies highlight partners in the initial 'DHP støttepakke' project.\
